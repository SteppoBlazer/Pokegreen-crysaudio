...
;ENDM
	...
	const MUSIC_UNUSED_TRADE
	const MUSIC_UNUSED_GIOTHEME
	const MUSIC_UNUSED_DIGDA01
	const MUSIC_UNUSED_TENSE
	const MUSIC_CRYS_MT_MOON
	const MUSIC_CRYS_ROCKETHD
	const MUSIC_CRYS_VICTROAD
	const MUSIC_CRYS_VIRIDIAN
	const MUSIC_ZUMI_HGSSSAFARI
	const MUSIC_ROUTES5
	const MUSIC_CRYS_GYMBATTLE
	const MUSIC_DEFEATED_ELITE4
	;const MUSIC_RMVX_DUNGEON01
	;const MUSIC_RM95_TOWN3
	const NUM_SONGS
