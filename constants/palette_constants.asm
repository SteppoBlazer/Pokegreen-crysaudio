...
; SuperPalettes indexes (see data/sgb/sgb_palettes.asm)
	...
	const PAL_NIGHTCAVE ; $25
	const PAL_NIGHT     ; $26
	const PAL_SHINYMEWMON    ; $27
	const PAL_SHINYBLUEMON   ; $28
	const PAL_SHINYREDMON    ; $29
	const PAL_SHINYCYANMON   ; $2A
	const PAL_SHINYPURPLEMON ; $2B
	const PAL_SHINYBROWNMON  ; $2C
	const PAL_SHINYGREENMON  ; $2D
	const PAL_SHINYPINKMON   ; $2E
	const PAL_SHINYYELLOWMON ; $2F
	const PAL_SHINYGREYMON ;30
