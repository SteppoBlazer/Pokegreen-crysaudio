...
GhostPic::             INCBIN "gfx/pokemon/front/ghost.pic"
...
RAdminMPic::       INCBIN "gfx/trainers/archer.pic"

SECTION "Trainer Pics 2", ROMX

ProfOakPic::       INCBIN "gfx/trainers/prof.oak.pic"
RAdminFPic::       INCBIN "gfx/trainers/delinquent.pic"
...
RedPicBack::       INCBIN "gfx/battle/redb.pic"
