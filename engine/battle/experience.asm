...
.next2
	...
	farcall AnimateEXPBar;new code
	call LoadMonData
	pop hl
...
;FIXED: fixing skip move-learn glitch: need to store the current level in wram
	ld [wTempCoins1], a;new code
	cp d
	jp z, .nextMon ; if level didn't change, go to next mon
	push hl;new code start
...
.inc_level	; marker for looping back 
	...
	push bc	;save b & c on the stack as they hold the current a true final leve
