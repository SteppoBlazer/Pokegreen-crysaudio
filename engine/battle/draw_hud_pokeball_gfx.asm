...
PlacePlayerHUDTiles:
	...
	ld bc, $3
	call CopyData
	;ld a, [wBattleMonSpecies2];----NEW CODE BEGIN
	;and a
	;jr z, .pokeBallHUD
	;ld a, $75 ; exp bar right corner tile
	;ld [wHUDGraphicsTiles + 1], a
;.pokeBallHUD;----NEW CODE END
	hlcoord 18, 10
	ld de, -1
	jr PlaceHUDTiles
...
PlaceEnemyHUDTiles:
	...
	jr z, .notOwned
	coord hl, 1, 1
	ld [hl], $75 ; caught pokeball tile
.notOwned;-------NEW CODE END
	hlcoord 1, 2
	ld de, $1
	;jr PlaceHUDTiles ORIGINAL CODE
	jp PlaceHUDTiles
